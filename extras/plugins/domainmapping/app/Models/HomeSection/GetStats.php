...
class GetStats
{
    ...
    public static function getValues($value)
    {
        if (empty($value)) {
            ...
            $value['icon_count_listings'] = $value['icon_count_listings'] ?? 'fas fa-bullhorn';
            $value['custom_icon_count_listings'] = $value['custom_icon_count_listings'] ?? null;
            $value['icon_count_users'] = $value['icon_count_users'] ?? 'fas fa-users';
            $value['custom_icon_count_users'] = $value['custom_icon_count_users'] ?? null;
            $value['icon_count_locations'] = $value['icon_count_locations'] ?? 'far fa-map';
            $value['custom_icon_count_locations'] = $value['custom_icon_count_locations'] ?? null;
            $value['counter_up_delay'] = $value['counter_up_delay'] ?? 10;
            $value['counter_up_time'] = $value['counter_up_time'] ?? 2000;
        }
