...
class DomainController extends PanelController
{
	public function setup()
	{
		...
		|--------------------------------------------------------------------------
		*/
		$this->xPanel->setModel(Domain::class);
		...
		$this->xPanel->addButtonFromModelFunction('line', 'sections', 'sectionsButton', 'beginning');
	...
	public function createBulkCountriesSubDomain()
	{
		...
		try {
			...
			if ($success) {
				$message = trans('domainmapping::messages.The sub-domains were been created');
				notification($message, 'success');
			} else {
				$message = trans('domainmapping::messages.Sub-domains have already been created');
