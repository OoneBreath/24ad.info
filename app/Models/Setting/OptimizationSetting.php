			...
			[
				...
				'value'   => trans('admin.card_light_warning', [
					'content' => trans('admin.queue_driver_info', [
                                                'cmd' => getRightPathsForCmd('php artisan queue:work --queue=mail,sms,thumbs,default --tries=3 --timeout=180 --max-time=300 --max-jobs=10 --sleep=10 --memory=256', wrapped: false),
					]),
				]),
				'wrapper' => [
					'class' => 'col-md-12',
